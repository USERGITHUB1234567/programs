...
long double x,y,x1,y_1,x2,y2;
long double dist(point a, line del) {
    long double ans=fabsl(del.a*a.x+del.b*a.y+del.c)/hypotl(del.a,del.b);return ans;
}
int main() {
    ios::sync_with_stdio(false);cin.tie(nullptr);cout.tie(nullptr);
    cin >> x >> y >> x1 >> y_1 >> x2 >> y2;
    long double t1=-(y2-y_1),t2=(x2-x1);
    line a={t1,t2,-t1*x1-t2*y_1};
    long double ans=dist({x,y},a);
